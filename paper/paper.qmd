...
bias_summary_with_total %>%
  kable(
    col.names = c("Year", "Race", "Ethnicity", "Religion", "Gender", "Sexual Orientation", "Disability", "Total"),
...
@fig-yearly-occurrence illustrates the annual occurrences of hate crimes from 2018 to 2023. The data indicates a clear upward trend in the number of reported hate crimes over this period. Starting from approximately 154 occurrences in 2018, there is a steady increase each year, culminating in a significant rise to over 392 occurrences in 2023.
